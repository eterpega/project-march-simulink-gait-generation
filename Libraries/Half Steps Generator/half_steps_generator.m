...
varNameStopStepFromStandHip     = 'halfStepStopFromStandHip';
     ...
     if exist(sectionObj, varNameStartStepHip) && exist(sectionObj, varNameStartStepKnee)...
      ...
      elseif ~exist(sectionObj,startStepHipEntryObj) || ~exist(sectionObj,startStepKneeEntryObj)...
            || ~exist(sectionObj,stopStepFromSwingKneeEntryObj) || ~exist(sectionObj,stopStepFromSwingHipEntryObj)...
            || ~exist(sectionObj,stopStepFromStandKneeEntryObj) || ~exist(sectionObj,stopStepFromStandHipEntryObj)
        
        %Open question box for confirmation
        questionStr=['WARNING: Some or all of the half step vectors Entries ',...
